...
- **HUD depth**: ~~"train to unlock" gear hints~~ DONE 10w; ~~per-slot item ICONS~~ DONE 11k; ~~region danger readout~~ DONE 11l; ~~effective combat stats (deriveStats) on the sheet~~ DONE 11m (you ⚔X vs region ⚔N now comparable). Next: richer paperdoll (per-item silhouettes); inventory/equipment grid; a colour cue when your in-battle stats trail the region danger.
