...
- **HUD depth**: richer paperdoll (per-item silhouettes); ~~monster shape variety~~ DONE 9y (archetype silhouettes: ooze/drake/brute/critter); inventory/equipment grid; OSRS-style icon sub-tabs if a room crowds.
