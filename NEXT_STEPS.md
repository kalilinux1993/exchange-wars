...
- **HUD depth**: ~~"train to unlock" gear hints~~ DONE 10w; ~~per-slot item ICONS in the equiplist~~ DONE 11k. Next: richer paperdoll (per-item silhouettes); inventory/equipment grid; OSRS-style icon sub-tabs if a room crowds.
