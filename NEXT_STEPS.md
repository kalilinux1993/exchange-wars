...
- **Trading**: ~~suggested-flip margin line~~ DONE 10j; ~~fair-value band~~ DONE 10m (cheap/fair/rich vs cost→value); ~~sparkline in market-table rows~~ ALREADY DONE (Spark in MarketTable, sparkcell column). Next idea: a spread / flip-ability column or "best flip now" highlight across all rows.
