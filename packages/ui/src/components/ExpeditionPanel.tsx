        ...
        <>
          ...
          <div className="controls">
            <button className="chip" onClick={() => onCommand({ type: 'choose', accept: true })}>
              {{ shrine: 'pay the tithe', gamble: 'roll the dice', portal: 'step through', imp: 'chase it', merchant: 'pay up', spar: 'take the lesson', toll: 'pay the toll', courier: 'ship it home' }[
                exp.event.kind
              ] ?? 'accept'}
            </button>
