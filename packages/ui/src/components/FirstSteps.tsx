...
export function firstSteps(game: Game, view: PlayerView): FirstStep[] {
  return [
    { label: 'Place your first trade in the Grand Exchange', done: game.fills.length > 0 },
    { label: 'Hire a clerk in the Hall to flip for you', done: (view.upgrades['autoFlip'] ?? 0) > 0 },
    { label: 'Delve on an Adventure — fell a monster', done: (game.world.stats.monstersSlain ?? 0) > 0 },
    {
 ...
 */
export function FirstSteps({ game, view }: { game: Game; view: PlayerView }) {
