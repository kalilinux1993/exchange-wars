...
export const TUNING = {
  ...
  automation: {
    autoFlip: [
      ...
      // spawners). Current best (56-item two-track wiki catalog): cadence 9 /
      // vol 0.10 — min cell +447, avg +1,320. Sweep, don't probe.
      { cadence: 9, maxFlips: 1, maxQty: 6, capitalFraction: 0.25, maxVolatility: 0.1 },
