...
export const DEFAULT_ITEMS: ItemDef[] = [
  ...
  { id: 'death_rune', name: 'Death rune', baseCost: 220, consumeValue: 430, volatility: 0.07 },
  ...
  { id: 'red_chinchompa', name: 'Red chinchompa', baseCost: 1150, consumeValue: 2250, volatility: 0.13 },
